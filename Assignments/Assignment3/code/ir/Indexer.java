...
public class Indexer {
    ...
    /** Constructor */
    public Indexer( Index index, String patterns_file , KGramIndex kindex) {
	this.index = index;
    ...
    public void PageRankFile(){
    	System.out.println("We store the PageRanks in the index");
    	//Open the file:
		...
		try {
    		...
    		while (line != null) {
    			...
    			index.pageRank_docid.add(Integer.parseInt(doc_id));
    			index.pageRank_values.add(Double.parseDouble(value));
        		line = br.readLine();
    		}
    		br.close();
		} catch (IOException e) {
		...
		System.out.println("Hem acabat de llegir el file:");
    }
